...
(define-derived-mode simpc-mode c++-mode "Simple C"
  ...
  ;; Keep the custom highlighting, but delegate structural indentation to
  ;; `c++-mode'.  The hand-written indenter only looked at the previous line,
  ;; which cannot correctly balance nested switch/case blocks.
